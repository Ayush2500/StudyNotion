...
exports.createRating = async (req, res) => {
  try {
    ...
    const courseDetails = await Course.findOne({
      _id: courseObjectId,
      studentsEnroled: userObjectId,
    });

    // Log the courseDetails
    ...
    // Log the alreadyReviewed details
...
exports.getAverageRating = async (req, res) => {
  try {
    ...
    const result = await RatingAndReview.aggregate([
      {
        $match: {
          course: courseObjectId, // Convert courseId to ObjectId
        },
      },
      {
        $group: {
