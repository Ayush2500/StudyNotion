        ...
        <div>
            <div className='flex flex-col lg:flex-row gap-20 mb-20 items-center'>
                ...
                <div className='relative shadow-blue-200 shadow-[0px_0px_30px_0px] w-fit h-fit'>
                    ...
                    <div className='absolute bg-caribbeangreen-700 flex lg:flex-row flex-col text-white uppercase py-5
                                    lg:left-[50%] gap-4 lg:gap-0 lg:py-10 lg:translate-x-[-50%] lg:translate-y-[-50%]'>
